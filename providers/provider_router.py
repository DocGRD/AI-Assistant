...
class ProviderRouter:
    ...
    def generate(
        ...
        # WebUI is the final fallback — but for a private request only with opt-in,
        # because a handoff means the user pastes content into a web AI.
        if (not private) or allow_webui_on_private:
