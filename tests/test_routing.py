...
from providers.model_registry import ModelRegistry, UNHEALTHY_THRESHOLD
...
class RoutingTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # loads it — same path the router uses at startup.
    ...
    def test_small_default_prefers_google(self):
        order = self.reg.route_order(ACTIVE, private=False, est_tokens=200, response_tokens=500)
        self.assertEqual(order[0], "google")
