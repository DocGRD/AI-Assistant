...
## Bible translations
The bundled base version is **WEB** (World English Bible, public domain). To read another translation you
have legal access to, add it by hand with **"Bible: paste a chapter (new translation)"** — paste the raw
text and LoreMaster formats it into the standard verse layout in your vault (see [[Features]]). There is no
online-fetch/API path: nothing about scripture leaves your machine.
